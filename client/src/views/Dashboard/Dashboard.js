...
class Dashboard extends Component {
  ...
  componentDidMount() {
    axios.get('/api/product/all/page')
      .then(res => {
        this.setState({
          products: res.data
        });
      ...
      axios.get('/api/order/order/count')
      .then(res => {
        this.setState({
          ordercount: res.data
        });
        ...
        <Row>
          ...
          <Col xs="12" sm="6" lg="3">
            <Card className="text-white bg-primary">
              <CardBody className="pb-0">
                <div className="text-value">{this.state.products.totalProducts}</div>
          ...
          <Col xs="12" sm="6" lg="3">
            <Card className="text-white bg-info">
              <CardBody className="pb-0">
                <div className="text-value">{this.state.ordercount}</div>
